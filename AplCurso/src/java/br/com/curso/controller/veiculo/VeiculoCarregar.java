 ...
 * @author muril
 */
@WebServlet(name = "VeiculoCarregar", urlPatterns = {"/VeiculoCarregar"})
public class VeiculoCarregar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            try{
                ...
                request.setAttribute("veiculo", oVeiculoDAO.carregar(idVeiculo));
                ...
                System.out.println("Erro ao carregar veiculo: " + ex.getMessage());
                ex.printStackTrace();
            }
    }
