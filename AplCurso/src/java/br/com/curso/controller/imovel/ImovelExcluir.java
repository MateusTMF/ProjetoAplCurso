 ...
 * @author muril
 */
@WebServlet(name = "ImovelExcluir", urlPatterns = {"/ImovelExcluir"})
public class ImovelExcluir extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            try{
                ...
                if(dao.excluir(idImovel)){
                    ...
                    mensagem = "Problemas ao excluir IMovel";
                }
                request.setAttribute("mensagem", mensagem);
                response.sendRedirect("ImovelListar");
            }catch (Exception ex){
                System.out.println("Problemas no servlet ao excluir Imovel! Erro: " + ex.getMessage());
                ex.printStackTrace();
        }
    }
